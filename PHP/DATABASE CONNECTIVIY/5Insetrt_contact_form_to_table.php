...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">|| ASISH ||</a>
...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if(empty($name)){$err1="Mandatory-1";$validate=False;}
      if(empty($email)){$err2="Mandatory-2";$validate=False;}
      if(empty($message)){$err3="Mandatory-3";$validate=False;}
